...
from cadenya.types import Subject
...
class TestSubjects:
    ...
    def test_method_list(self, client: Cadenya) -> None:
        subject = client.tenants.subjects.list(
            tenant_id="tenantId",
            workspace_id="workspace_01HXKD2E5NQM3T9AYWCF133E3Q",
        )
        assert_matches_type(SyncCursorPagination[Subject], subject, path=["response"])
    ...
    def test_raw_response_list(self, client: Cadenya) -> None:
        response = client.tenants.subjects.with_raw_response.list(
            tenant_id="tenantId",
            workspace_id="workspace_01HXKD2E5NQM3T9AYWCF133E3Q",
        )
    ...
    def test_streaming_response_list(self, client: Cadenya) -> None:
        with client.tenants.subjects.with_streaming_response.list(
            tenant_id="tenantId",
            workspace_id="workspace_01HXKD2E5NQM3T9AYWCF133E3Q",
        ) as response:
    ...
    def test_path_params_list(self, client: Cadenya) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `workspace_id` but received ''"):
            client.tenants.subjects.with_raw_response.list(
                tenant_id="tenantId",
                workspace_id="",
            )
...
class TestAsyncSubjects:
    ...
    async def test_method_list(self, async_client: AsyncCadenya) -> None:
        subject = await async_client.tenants.subjects.list(
            tenant_id="tenantId",
            workspace_id="workspace_01HXKD2E5NQM3T9AYWCF133E3Q",
        )
        assert_matches_type(AsyncCursorPagination[Subject], subject, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncCadenya) -> None:
        response = await async_client.tenants.subjects.with_raw_response.list(
            tenant_id="tenantId",
            workspace_id="workspace_01HXKD2E5NQM3T9AYWCF133E3Q",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncCadenya) -> None:
        async with async_client.tenants.subjects.with_streaming_response.list(
            tenant_id="tenantId",
            workspace_id="workspace_01HXKD2E5NQM3T9AYWCF133E3Q",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_list(self, async_client: AsyncCadenya) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `workspace_id` but received ''"):
            await async_client.tenants.subjects.with_raw_response.list(
                tenant_id="tenantId",
                workspace_id="",
            )
