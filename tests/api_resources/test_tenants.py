...
from cadenya.types import Tenant
...
class TestTenants:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_retrieve_with_all_params(self, client: Cadenya) -> None:
        tenant = client.tenants.retrieve(
            id="id",
            workspace_id="workspace_01HXKD2E5NQM3T9AYWCF133E3Q",
            include_info=True,
    ...
    def test_method_list(self, client: Cadenya) -> None:
        ...
        assert_matches_type(SyncCursorPagination[Tenant], tenant, path=["response"])
    ...
    def test_streaming_response_list(self, client: Cadenya) -> None:
        with client.tenants.with_streaming_response.list(
            workspace_id="workspace_01HXKD2E5NQM3T9AYWCF133E3Q",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_list(self, client: Cadenya) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `workspace_id` but received ''"):
            client.tenants.with_raw_response.list(
                workspace_id="",
            )
...
class TestAsyncTenants:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_retrieve_with_all_params(self, async_client: AsyncCadenya) -> None:
        tenant = await async_client.tenants.retrieve(
            id="id",
            workspace_id="workspace_01HXKD2E5NQM3T9AYWCF133E3Q",
            include_info=True,
    ...
    async def test_method_list(self, async_client: AsyncCadenya) -> None:
        ...
        assert_matches_type(AsyncCursorPagination[Tenant], tenant, path=["response"])
    ...
    async def test_streaming_response_list(self, async_client: AsyncCadenya) -> None:
        async with async_client.tenants.with_streaming_response.list(
            workspace_id="workspace_01HXKD2E5NQM3T9AYWCF133E3Q",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncCadenya) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `workspace_id` but received ''"):
            await async_client.tenants.with_raw_response.list(
                workspace_id="",
            )
