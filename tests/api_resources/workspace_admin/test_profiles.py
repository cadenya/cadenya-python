...
class TestProfiles:
    ...
    def test_method_list(self, client: Cadenya) -> None:
        ...
        assert_matches_type(SyncCursorPagination[Profile], profile, path=["response"])
    ...
    def test_raw_response_list(self, client: Cadenya) -> None:
        response = client.workspace_admin.profiles.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Cadenya) -> None:
        with client.workspace_admin.profiles.with_streaming_response.list() as response:
...
class TestAsyncProfiles:
    ...
    async def test_method_list(self, async_client: AsyncCadenya) -> None:
        ...
        assert_matches_type(AsyncCursorPagination[Profile], profile, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncCadenya) -> None:
        response = await async_client.workspace_admin.profiles.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncCadenya) -> None:
        async with async_client.workspace_admin.profiles.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
