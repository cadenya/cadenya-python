...
class TestMembers:
    ...
    def test_path_params_list(self, client: Cadenya) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `workspace_id` but received ''"):
            client.workspace_admin.members.with_raw_response.list(
                workspace_id="",
            )
    ...
    def test_path_params_add(self, client: Cadenya) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `workspace_id` but received ''"):
            client.workspace_admin.members.with_raw_response.add(
                workspace_id="",
            )
...
class TestAsyncMembers:
    ...
    async def test_path_params_list(self, async_client: AsyncCadenya) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `workspace_id` but received ''"):
            await async_client.workspace_admin.members.with_raw_response.list(
                workspace_id="",
            )
    ...
    async def test_path_params_add(self, async_client: AsyncCadenya) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `workspace_id` but received ''"):
            await async_client.workspace_admin.members.with_raw_response.add(
                workspace_id="",
            )
