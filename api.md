...
- <code title="get /v1/workspaces/{workspaceId}/bulk_workspace_applies/{id}">client.bulk_workspace_resources.<a href="./src/cadenya/resources/bulk_workspace_resources/bulk_workspace_resources.py">retrieve</a>(id, \*, workspace_id) -> <a href="./src/cadenya/types/bulk_workspace_apply.py">BulkWorkspaceApply</a></code>
- <code title="get /v1/workspaces/{workspaceId}/bulk_workspace_applies">client.bulk_workspace_resources.<a href="./src/cadenya/resources/bulk_workspace_resources/bulk_workspace_resources.py">list</a>(workspace_id, \*\*<a href="src/cadenya/types/bulk_workspace_resource_list_params.py">params</a>) -> <a href="./src/cadenya/types/bulk_workspace_apply.py">SyncCursorPagination[BulkWorkspaceApply]</a></code>
- <code title="post /v1/workspaces/{workspaceId}/bulk_workspace_applies">client.bulk_workspace_resources.<a href="./src/cadenya/resources/bulk_workspace_resources/bulk_workspace_resources.py">apply</a>(workspace_id, \*\*<a href="src/cadenya/types/bulk_workspace_resource_apply_params.py">params</a>) -> <a href="./src/cadenya/types/bulk_workspace_apply.py">BulkWorkspaceApply</a></code>
...
```python
from cadenya.types.bulk_workspace_resources import (
...
- <code title="get /v1/workspaces/{workspaceId}/bulk_workspace_applies/{bulkWorkspaceApplyId}/results">client.bulk_workspace_resources.results.<a href="./src/cadenya/resources/bulk_workspace_resources/results.py">list</a>(bulk_workspace_apply_id, \*, workspace_id, \*\*<a href="src/cadenya/types/bulk_workspace_resources/result_list_params.py">params</a>) -> <a href="./src/cadenya/types/bulk_workspace_resources/bulk_workspace_apply_result.py">SyncCursorPagination[BulkWorkspaceApplyResult]</a></code>
