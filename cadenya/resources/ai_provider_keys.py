...
class AiProviderKeys:
    ...
    def list(
        ...
        *,
        ...
        _items = decode_response("ai_provider_keys.list", _data, lambda _d: [types.AIProviderKey._from_json(item) for item in (_d.get("items") or [])])
        _next_cursor = (((_data).get("pagination") or {})).get("nextCursor") or ""

        def _fetch(_cursor: str) -> SyncPage[types.AIProviderKey]:
            return self.list(workspace_id=workspace_id, limit=limit, cursor=_cursor, prefix=prefix, query=query, promotional=promotional, labels=labels, sort_order=sort_order, include_info=include_info, request_options=request_options)
    ...
    def create(
        ...
        *,
        ...
        spec: types.AIProviderKeySpecParam,
        workspace_id: Optional[str] = None,
        request_options: Optional[RequestOptions] = None,
    ) -> types.AIProviderKey:
        ...
        return decode_response("ai_provider_keys.create", _data, lambda _d: types.AIProviderKey._from_json(_d))
    ...
    def update(
        ...
        *,
        ...
        return decode_response("ai_provider_keys.update", _data, lambda _d: types.AIProviderKey._from_json(_d))
