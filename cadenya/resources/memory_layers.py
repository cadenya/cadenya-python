...
class MemoryLayers:
    def __init__(self, core: Core) -> None:
        self._core = core
        self.entries = MemoryEntries(core)
    ...
    def list(
        ...
        *,
        ...
        type: Optional[types.MemoryServiceListMemoryLayersType] = None,
        agent_id: Optional[str] = None,
        episodic_key_prefix: Optional[str] = None,
        labels: Optional[str] = None,
        sort_order: Optional[str] = None,
        include_info: Optional[bool] = None,
        request_options: Optional[RequestOptions] = None,
    ) -> SyncPage[types.MemoryLayer]:
        """List memory layers"""
        workspace_id = self._core.resolve_default("workspaceId", "CADENYA_WORKSPACE_ID", workspace_id)
        _path = f"/v1/workspaces/{path_param('workspaceId', workspace_id)}/memory_layers"
        _query = {
            "limit": limit,
            "cursor": cursor,
            "prefix": prefix,
        ...
        _items = decode_response("memory_layers.list", _data, lambda _d: [types.MemoryLayer._from_json(item) for item in (_d.get("items") or [])])
        _next_cursor = (((_data).get("pagination") or {})).get("nextCursor") or ""

        def _fetch(_cursor: str) -> SyncPage[types.MemoryLayer]:
            return self.list(workspace_id=workspace_id, limit=limit, cursor=_cursor, prefix=prefix, query=query, type=type, agent_id=agent_id, episodic_key_prefix=episodic_key_prefix, labels=labels, sort_order=sort_order, include_info=include_info, request_options=request_options)
    ...
    def create(
        ...
        *,
        ...
        spec: types.MemoryLayerSpecParam,
        workspace_id: Optional[str] = None,
        request_options: Optional[RequestOptions] = None,
    ) -> types.MemoryLayer:
        ...
        _body = {
            ...
            "spec": (lambda _v: types._encode_MemoryLayerSpec(_v))(spec),
        }
        ...
        return decode_response("memory_layers.create", _data, lambda _d: types.MemoryLayer._from_json(_d))
    ...
    def retrieve(
        ...
        *,
        ...
        workspace_id = self._core.resolve_default("workspaceId", "CADENYA_WORKSPACE_ID", workspace_id)
        _path = f"/v1/workspaces/{path_param('workspaceId', workspace_id)}/memory_layers/{path_param('id', id)}"
        _data = self._core.request("GET", _path, request_options=request_options)
        return decode_response("memory_layers.retrieve", _data, lambda _d: types.MemoryLayer._from_json(_d))
    ...
    def update(
        ...
        *,
        ...
        spec: Optional[types.MemoryLayerSpecParam] = None,
        ...
        return decode_response("memory_layers.update", _data, lambda _d: types.MemoryLayer._from_json(_d))
