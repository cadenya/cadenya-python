...
from ..agents.variation_memory_layer_assignment import VariationMemoryLayerAssignment

__all__ = ["BulkWorkspaceApplyResultDataVariationMemoryLayerOutcome", "Error", "ErrorDetail"]
...
class BulkWorkspaceApplyResultDataVariationMemoryLayerOutcome(BaseModel):
    action: Optional[
        Literal[
            "ACTION_UNSPECIFIED",
            "ACTION_CREATED",
