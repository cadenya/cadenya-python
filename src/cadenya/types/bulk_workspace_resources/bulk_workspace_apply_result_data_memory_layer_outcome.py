...
__all__ = ["BulkWorkspaceApplyResultDataMemoryLayerOutcome", "Error", "ErrorDetail"]
...
class BulkWorkspaceApplyResultDataMemoryLayerOutcome(BaseModel):
    action: Optional[
        Literal[
            "ACTION_UNSPECIFIED",
            "ACTION_CREATED",
    ...
    resource: Optional[MemoryLayer] = None
    """
