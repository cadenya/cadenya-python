...
__all__ = ["BulkWorkspaceApplyResultDataAgentScheduleOutcome", "Error", "ErrorDetail"]
...
class BulkWorkspaceApplyResultDataAgentScheduleOutcome(BaseModel):
    action: Optional[
        Literal[
            "ACTION_UNSPECIFIED",
            "ACTION_CREATED",
    ...
    resource: Optional[AgentSchedule] = None
    """
