...
__all__ = ["BulkWorkspaceApplyResultDataToolSetOutcome", "Error", "ErrorDetail"]
...
class BulkWorkspaceApplyResultDataToolSetOutcome(BaseModel):
    action: Optional[
        Literal[
            "ACTION_UNSPECIFIED",
            "ACTION_CREATED",
    ...
    resource: Optional[ToolSet] = None
