...
__all__ = ["BulkWorkspaceApplyResultDataAgentVariationOutcome", "Error", "ErrorDetail"]
...
class BulkWorkspaceApplyResultDataAgentVariationOutcome(BaseModel):
    action: Optional[
        Literal[
            "ACTION_UNSPECIFIED",
            "ACTION_CREATED",
    ...
    resource: Optional[AgentVariation] = None
