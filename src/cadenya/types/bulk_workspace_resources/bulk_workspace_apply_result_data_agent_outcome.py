...
__all__ = ["BulkWorkspaceApplyResultDataAgentOutcome", "Error", "ErrorDetail"]
...
class BulkWorkspaceApplyResultDataAgentOutcome(BaseModel):
    action: Optional[
        Literal[
            "ACTION_UNSPECIFIED",
            "ACTION_CREATED",
